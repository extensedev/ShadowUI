...
/// <summary>Base neutral palette of the theme (as in shadcn/ui).</summary>
public enum BaseColor
{
    /// <summary>Zinc neutral palette (default).</summary>
    Zinc,

    /// <summary>Slate neutral palette (cool tone).</summary>
    Slate,

    /// <summary>Stone neutral palette (warm tone).</summary>
    Stone,

    /// <summary>Gray neutral palette.</summary>
    Gray,
